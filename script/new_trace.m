...
%DT = THROTTLE_MIN + rand(1,n) * (THROTTLE_MAX-THROTTLE_MIN);    %Generate random values for Throttle signal
%DB = BRAKE_MIN    + rand(1,n) * (BRAKE_MAX-BRAKE_MIN);          %Generate random values for Brake signal
